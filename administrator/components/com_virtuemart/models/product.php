 ...
 * @version $Id: product.php 6355 2012-08-20 09:23:27Z Milbo $
 */
...
// 				vmdebug('my product ',$product);
	...
	private function getProductCategories ($virtuemart_product_id = 0, $front = FALSE) {
		...
		if ($virtuemart_product_id > 0) {
			...
			if ($front) {
				$q .= ' AND `published`=1';
			} // ANDREW Добавить категроии которые не должны добавляться к урлу товара
			$q .= ' AND virtuemart_category_id NOT IN (17,16,4,12,1,6,3,18)';			
