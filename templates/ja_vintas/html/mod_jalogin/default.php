...
<?php else : ?>
	<li>
		<a class="login-switch" href="<?php echo JRoute::_('index.php?option=com_user&view=login');?>" onclick="showBox('ja-user-login','mod_login_username',this, window.event || event);return false;" title="<?php echo JText::_('TXT_LOGIN');?>"><span><?php echo JText::_('Войти');?></span></a>
		...
		<div id="ja-user-register" style="width:240px;">
			...
			<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate">
				...
				<?php endif;?>
					<dl>
							<dt>
									<label  class="hasTip required" for="jform_name" id="jform_name-lbl"><?php echo JText::_( 'JANAME' ); ?>:</label><em>*</em></dt>
