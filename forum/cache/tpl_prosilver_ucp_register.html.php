...
<!-- begin mod: Anti Bot Question --><?php if ($this->_rootref['S_ABQ_CODE']) {  ?>
	<dl>
		<dt><label for="AB_Question"><?php echo ((isset($this->_rootref['L_AB_QUESTION'])) ? $this->_rootref['L_AB_QUESTION'] : ((isset($user->lang['AB_QUESTION'])) ? $user->lang['AB_QUESTION'] : '{ AB_QUESTION }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_AB_QUESTION_EXPLAIN'])) ? $this->_rootref['L_AB_QUESTION_EXPLAIN'] : ((isset($user->lang['AB_QUESTION_EXPLAIN'])) ? $user->lang['AB_QUESTION_EXPLAIN'] : '{ AB_QUESTION_EXPLAIN }')); ?></span></dt>
		<dd><input type="text" tabindex="6" name="AB_Question" id="AB_Question" size="25" maxlength="255" value="<?php echo (isset($this->_rootref['AB_QUESTION'])) ? $this->_rootref['AB_QUESTION'] : ''; ?>" class="inputbox autowidth" title="<?php echo ((isset($this->_rootref['L_AB_QUESTION'])) ? $this->_rootref['L_AB_QUESTION'] : ((isset($user->lang['AB_QUESTION'])) ? $user->lang['AB_QUESTION'] : '{ AB_QUESTION }')); ?>" /></dd>
	</dl>
	<?php } ?><!-- end mod: Anti Bot Question -->
	<hr />
