<?php $_role_mask_count = (isset($this->_tpldata['role_mask'])) ? sizeof($this->_tpldata['role_mask']) : 0;if ($_role_mask_count) {for ($_role_mask_i = 0; $_role_mask_i < $_role_mask_count; ++$_role_mask_i){$_role_mask_val = &$this->_tpldata['role_mask'][$_role_mask_i]; ?>
