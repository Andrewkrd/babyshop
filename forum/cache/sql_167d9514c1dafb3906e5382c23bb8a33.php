...
/* SELECT s.style_id, c.theme_data, c.theme_path, c.theme_name, c.theme_mtime, i.*, t.template_path FROM phpbb3x_styles s, phpbb3x_styles_template t, phpbb3x_styles_theme c, phpbb3x_styles_imageset i WHERE s.style_id = 1 AND t.template_id = s.template_id AND c.theme_id = s.theme_id AND i.imageset_id = s.imageset_id */

$expired = (time() > 1349331639) ? true : false;
if ($expired) { return; }
