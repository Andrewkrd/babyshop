...
// 3.5.1.1299
// saved at: 2012-09-24 21:28:47
// by: admin (id: 42 )
// domain: http://newbabyshop
...
$defaultComponentStringList = array("acymailing"=>"","banners"=>"","contact"=>"","content"=>"","finder"=>"","jaextmanager"=>"","joomlaupdate"=>"","login"=>"","mailto"=>"","newsfeeds"=>"","search"=>"","weblinks"=>"","wrapper"=>"","k2"=>"","virtuemart"=>"","virtuemart_allinone"=>"");
$pageTexts = array("ru-RU"=>"Page-%s","en-GB"=>"Page-%s");
